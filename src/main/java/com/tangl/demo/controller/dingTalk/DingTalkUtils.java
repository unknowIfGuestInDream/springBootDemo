...
public class DingTalkUtils {
    ...
    //钉钉开发文档https://ding-doc.dingtalk.com/doc#/serverapi2/qf2nxq/e9d991e2
    public OapiRobotSendResponse sendMsg(String msg) throws ApiException, NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
        ...
        link.setText("这个即将发布的新版本，创始人xx称它为红树林。而在此之前，每当面临重大升级，产品经理们都会取一个应景的代号，这一次，为什么是红树林 业务报警");
        ...
        markdown.setText("业务报警 #### 杭州天气 @156xxxx8827\n" +
